...
class Data(object):
    def __init__(self, path, batch_size):
        ...
        self.path = "./LLMRec/LLMRec_c/movielens/ml100k_llmrec_format" #+ '/%d-core' % args.core
        self.batch_size = batch_size

        train_file = self.path + '/train.json'#+ '/%d-core/train.json' % (args.core)
        val_file = self.path + '/val.json' #+ '/%d-core/val.json' % (args.core)
        test_file = self.path + '/test.json' #+ '/%d-core/test.json'  % (args.core)
