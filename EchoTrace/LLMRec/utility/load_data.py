...
class Data(object):
    def __init__(self, path, batch_size):
        ...
        # data_path, folder = os.path.split(path)
        # args.data_path = data_path
        # args.dataset = folder

        train_file = self.path + '/train.json'
        val_file = self.path + '/test.json' 
        ...
        text_feats = np.load(os.path.join(self.path, 'text_feat.npy'))
    ...
    def create_adj_mat(self):
        ...
        print('create adjacency matrix', adj_mat.shape, time() - t1)
        ...
        print('normalize adjacency matrix', time() - t2)
