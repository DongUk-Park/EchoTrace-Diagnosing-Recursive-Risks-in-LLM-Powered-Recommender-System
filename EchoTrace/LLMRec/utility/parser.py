...
def parse_args():
    ...
    parser.add_argument('--data_path', nargs='?', default='./data/yelp/', help='Input data path, movielens, netflix, books, yelp')
    parser.add_argument('--seed', type=int, default=2022, help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='yelp_llmrec_format', help='Choose a dataset from {books_llmrec_format, netflix_valid_item, ml-1m_llmrec_format, yelp_llmrec_format}')
    ...
    parser.add_argument('--early_stopping_patience', type=int, default=10, help='Early Stop Patience')      #original : 7
...
#     parser.add_argument('--mask_rate', type=float, default=0.05, help='Mask rate')   
#     parser.add_argument('--mask', type=bool, default=True, help='If mask')   
#     parser.add_argument('--user_cat_rate', type=float, default=2.8, help='User cat rate')
#     parser.add_argument('--item_cat_rate', type=float, default=0.005, help='Item cat rate')
#     parser.add_argument('--model_cat_rate', type=float, default=0.02, help='Model cat rate')
