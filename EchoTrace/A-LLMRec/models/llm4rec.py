...
class llm4rec(nn.Module):
    def __init__(
        ...
        if llm_model == 'opt':
            ...
            # self.llm_model = OPTForCausalLM.from_pretrained("facebook/opt-6.7b", torch_dtype=torch.float16, use_safetensors=True).to("cuda")#, load_in_8bit=Ture, device_map="auto")
